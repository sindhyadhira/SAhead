...
const ScOrdersList = class {
    ...
    render() {
        var _a, _b;
        return (h("sc-dashboard-module", { key: '81febd589198881547fad4fa01b1a23c8c9aa028', class: "orders-list", error: this.error }, h("span", { key: '57501cfa3f99a138c46d2e7b7223e24f2d4ad687', slot: "heading" }, h("slot", { key: '8ebd01686589d1ff033476683b66e300a1ffe6d8', name: "heading" }, this.heading || wp.i18n.__('Order History', 'surecart'))), !!this.allLink && !!((_a = this.orders) === null || _a === void 0 ? void 0 : _a.length) && (h("sc-button", { key: 'fa832436f13e2ba836498f923e50a308d66e5280', type: "link", href: this.allLink, slot: "end", "aria-label": wp.i18n.sprintf(wp.i18n.__('View all %s', 'surecart'), this.heading || wp.i18n.__('Order History', 'surecart')) }, wp.i18n.__('View all', 'surecart'), h("sc-icon", { key: 'b990e397c09ef824eebaa979ab33189d0126fe2a', "aria-hidden": "true", name: "chevron-right", slot: "suffix" }))), this.renderContent(), !this.allLink && (h("sc-pagination", { key: '33cc38ceaf851e6fca9e578c0afc3abe4185e6ab', page: this.query.page, perPage: this.query.per_page, total: this.pagination.total, totalPages: this.pagination.total_pages, totalShowing: (_b = this === null || this === void 0 ? void 0 : this.orders) === null || _b === void 0 ? void 0 : _b.length, onScNextPage: () => this.nextPage(), onScPrevPage: () => this.prevPage() })), this.busy && h("sc-block-ui", { key: 'e7a9ca604e47bfaa10e694c3f1b50997ef9b370d' })));
    }
