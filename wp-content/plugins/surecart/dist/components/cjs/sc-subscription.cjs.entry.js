...
const ScSubscription = class {
    ...
    render() {
        ...
        return (index.h("sc-dashboard-module", { key: '35e53e55ff360f13b5546b133044ffc8b1c464b6', heading: this.heading || wp.i18n.__('Current Plan', 'surecart'), class: "subscription", error: this.error }, !!this.subscription && (index.h("sc-flex", { key: 'd077997b31adf3cfeeb3a271f08ddacbca9e9804', slot: "end", class: "subscription__action-buttons" }, this.updatePaymentMethodUrl && paymentMethodExists && (index.h("sc-button", { key: 'e82b3ad4b105a97ce601628ada0a10523f5ab6ca', type: "link", href: this.updatePaymentMethodUrl }, index.h("sc-icon", { key: '3d69a67d0bc313f6cc68df2774bc15091be92c94', name: "credit-card", slot: "prefix" }), wp.i18n.__('Update Payment Method', 'surecart'))), !paymentMethodExists && (index.h("sc-button", { key: 'ad259e13d9f64b007a3bafe05fdc9aafe61619f9', type: "link", href: addQueryArgs.addQueryArgs(window.location.href, {
                action: 'create',
            ...
            }) }, index.h("sc-icon", { key: '2e8748f053c7a9944e87064f2d5d8761227469cc', name: "credit-card", slot: "prefix" }), wp.i18n.__('Add Payment Method', 'surecart'))), !!Object.keys((_b = this.subscription) === null || _b === void 0 ? void 0 : _b.pending_update).length && (index.h("sc-button", { key: 'b482cf91bbbe5839c787142bcadb48710f497a61', type: "link", onClick: () => this.cancelPendingUpdate() }, index.h("sc-icon", { key: '2a2928fa95843796267ef8ab015c09850cf28e86', name: "x-octagon", slot: "prefix" }), wp.i18n.__('Cancel Scheduled Update', 'surecart'))), ((_c = this === null || this === void 0 ? void 0 : this.subscription) === null || _c === void 0 ? void 0 : _c.cancel_at_period_end) ? (index.h("sc-button", { type: "link", onClick: () => this.renewSubscription() }, index.h("sc-icon", { name: "repeat", slot: "prefix" }), wp.i18n.__('Restore Plan', 'surecart'))) : (((_d = this.subscription) === null || _d === void 0 ? void 0 : _d.status) !== 'canceled' &&
            ((_e = this.subscription) === null || _e === void 0 ? void 0 : _e.current_period_end_at) &&
            this.showCancel && (index.h("sc-button", { type: "link", onClick: () => (this.cancelModal = true) }, index.h("sc-icon", { name: "x", slot: "prefix" }), wp.i18n.__('Cancel Plan', 'surecart')))), ((_f = this.subscription) === null || _f === void 0 ? void 0 : _f.status) === 'canceled' && (index.h("sc-button", { key: 'be92b342fe3e7e203cb5bb414031d41bf2b34855', type: "link", ...(!!((_g = this.subscription) === null || _g === void 0 ? void 0 : _g.payment_method)
                ? {
                    onClick: () => (this.resubscribeModal = true),
                }
                : {
                    href: this === null || this === void 0 ? void 0 : this.updatePaymentMethodUrl,
                }) }, index.h("sc-icon", { key: '55bda62770851b0f5b73ac53504de95162d66f48', name: "repeat", slot: "prefix" }), wp.i18n.__('Resubscribe', 'surecart'))))), index.h("sc-card", { key: '3414de25e63c8f36559d9453a62a64e08f3064b8', style: { '--overflow': 'hidden' }, noPadding: true }, this.renderContent()), this.busy && index.h("sc-block-ui", { key: '7ce6bccfce80326a67dc4a44a6d4f3e78970b2e5', spinner: true }), index.h("sc-cancel-dialog", { key: 'bd23b5363096c29683bf7320b567ca0f24aa18b6', subscription: this.subscription, protocol: this.protocol, open: this.cancelModal, onScRequestClose: () => (this.cancelModal = false), onScRefresh: () => this.getSubscription() }), index.h("sc-subscription-reactivate", { key: 'a2dec1e246cbd8c6597f572b783f0a531ae82048', subscription: this.subscription, open: this.resubscribeModal, onScRequestClose: () => (this.resubscribeModal = false), onScRefresh: () => this.getSubscription() })));
    }
