...
const ScSubscriptionDetails = class {
    ...
    render() {
        return (index.h("div", { key: 'b36abe13480088de76ca6316f718a3e57fe30460', class: "subscription-details" }, this.hasPendingUpdate && (index.h("div", { key: '579bb7fb96b8ccc7affd6aeab3721c378f9eedb2' }, index.h("sc-tag", { key: '13af9cd0198606d4dae16383f2f7da5be4c1b956', size: "small", type: "warning" }, wp.i18n.__('Update Scheduled', 'surecart')))), index.h("sc-flex", { key: '73608895b32a191b388c10fd42901053e679bda3', alignItems: "center", justifyContent: "flex-start" }, index.h("sc-text", { key: '037006c291a1dcb4b14c3cdf1afd6e940f361eba', "aria-label": wp.i18n.sprintf(wp.i18n.__('Plan name - %s', 'surecart'), this.renderName()), style: { '--font-weight': 'var(--sc-font-weight-bold)' } }, this.renderName()), this.renderActivations()), !this.hideRenewalText && index.h("div", { key: '3fa3d2b627e068310a583d97b00a3ce300cd4c8c' }, this.renderRenewalText(), " "), index.h("slot", { key: '165e93dbc2aa65ffdd093bf5f413aa09b3011310' }), index.h("sc-dialog", { key: '24c0e4e7157a4f8ac1875cc169a0bfe782f7d2b3', label: wp.i18n.__('Activations', 'surecart'), onScRequestClose: () => (this.activationsModal = false), open: !!this.activationsModal }, index.h("sc-card", { key: '89b8147fa47934c1dc4f13a71378f4930abd6704', "no-padding": true, style: { '--overflow': 'hidden' } }, index.h("sc-stacked-list", { key: '1fd44c8cc0e78d728837a68e1812f9b95c59e5d4' }, (this.getActivations() || []).map(activation => {
        ...
        })))), this.showWarning() && (index.h("div", { key: '9150a04f32fcf63527712d83d787ab95cfcd935f' }, index.h("sc-tag", { key: '5bbc7131e1ec3485529dbe91f03f3941c8cda449', type: "warning" }, index.h("div", { key: 'f8b38c1fe9198c4d48c854cc1462ddbd922d0d84', class: "subscription-details__missing-method" }, index.h("sc-icon", { key: 'ac9059aa2b58a2d0e8ea7d8276e2642832db78f9', name: "alert-triangle" }), wp.i18n.__('Payment Method Missing', 'surecart')))))));
    }
...
const ScSubscriptionStatusBadge = class {
    ...
    render() {
        return (index.h("sc-tag", { key: 'a9f516f11c01753465954c777e5fc01ace3f4920', "aria-label": wp.i18n.sprintf(wp.i18n.__('Plan Status - %s', 'surecart'), this.getText()), type: this.getType() }, this.getText()));
    }
};
